...
class AboutRegularExpressions < Neo::Koan
  ...
  # if * fails to match it returns an empty string, not nil
  def test_asterisk_means_zero_or_more
    ...
    # never, unless * is followed by a non matching char
  end
  ...
  # they accept as many macthcing chars as possible
